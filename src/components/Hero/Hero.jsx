    ...
    return (
        <div className="flex flex-col justify-center w-full h-[100vh] bg-no-repeat bg-cover bg-center text-white text-center">
                <motion.div 
                    ...
                    className="text-[9rem] xs:text-6xl md:text-8xl lg:text-[8rem] xl:text-[9rem]
                    px-20 xs:px-0 sm:px-20 md:px-20
                    uppercase font-serif leading-none">
                    {props.title}
                </motion.div>
                <motion.div
                    key={uniqueKey}
                    ...
                    class="grid grid-rows-1 grid-flow-col gap-4 justify-center">

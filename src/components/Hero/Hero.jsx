...
const Hero = (props) => {
    const { title, subtitle, button1, button1link, button2, button2link, video, header, headerVideo, titleClass } = props;

    return (
        <div className="relative flex flex-col justify-center items-center w-full h-screen bg-no-repeat bg-cover bg-center text-white text-center">
            {/* Título */}
            <motion.p 
                key={uuidv4()}
